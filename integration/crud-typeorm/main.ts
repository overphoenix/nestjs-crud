...
import { CrudConfigService } from '@recalibratedsystems/nestjs-crud';
...
async function bootstrap() {
  ...
  const options = new DocumentBuilder()
    .setTitle('@recalibratedsystems/nestjs-crud-typeorm')
    .setDescription('@recalibratedsystems/nestjs-crud-typeorm')
    .setVersion('1.0')
    .build();
